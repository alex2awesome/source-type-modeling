...
from sentence_util import _get_attention_mask


class TokenizedDataset(Dataset):
    def __init__(self, doc_list=None, tokenizer=None, do_score=False, max_length=4096, label_mapper=None):
        """
        ...
        * doc_list: We expect a list of dictionaries.
        ...
        if label_mapper is not None:
            self.idx2label_mapper = {v:k for k,v in label_mapper.items()}
